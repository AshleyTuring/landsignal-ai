...
# Multi-LLM Orchestration Master Script - v5.2
# SINGLE-PASS VERSION (max 1 iteration)
#
# ⚠️  For ITERATIVE CONVERGENCE (multiple rounds until agreement), use:
#     → RUN_ALL_ITERATIVE_v5.sh
#
# Use this single-pass version for:
# - Quick testing/debugging
# - Manual control over iteration rounds
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║                                                              ║"
echo "║     Multi-LLM Property Search System v5.2                    ║"
echo "║     4 LLMs: Gemini, Codex, Grok, Claude                     ║"
echo "║     MODE: Single-Pass (max 1 iteration)                     ║"
echo "║                                                              ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
echo "  Phase 1.5: Technical Iteration (if disagreements - ONE PASS ONLY)"
echo "  Phase 2: Synthesis & Extraction (Claude)"
echo ""
echo "⚠️  NOTE: This version does NOT loop back for re-validation"
echo "   For iterative convergence, use: RUN_ALL_ITERATIVE_v5.sh"
echo ""
