...
generate_codex() {
    ...
    codex exec --skip-git-repo-check "Read the file at $OUTPUT_DIR/shared_context.txt and generate 1-3 unique property search strategies based on the requirements. You are an expert property development analyst." \
