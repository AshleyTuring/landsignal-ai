...
echo "" >> "$OUTPUT_DIR/shared_context.txt"
cat "$PROJECT_DIR/../FILTER_PATTERNS.md" >> "$OUTPUT_DIR/shared_context.txt" 2>/dev/null || echo "[FILTER_PATTERNS.md not found]" >> "$OUTPUT_DIR/shared_context.txt"

echo "" >> "$OUTPUT_DIR/shared_context.txt"
echo "## REFERENCE: LEARNINGS_DATABASE.md" >> "$OUTPUT_DIR/shared_context.txt"
echo "" >> "$OUTPUT_DIR/shared_context.txt"
cat "$PROJECT_DIR/../LEARNINGS_DATABASE.md" >> "$OUTPUT_DIR/shared_context.txt" 2>/dev/null || echo "[LEARNINGS_DATABASE.md not found]" >> "$OUTPUT_DIR/shared_context.txt"

echo "" >> "$OUTPUT_DIR/shared_context.txt"
echo "## REFERENCE: SearchLand Available Filters (CRITICAL - Use ONLY These)" >> "$OUTPUT_DIR/shared_context.txt"
echo "" >> "$OUTPUT_DIR/shared_context.txt"
cat "$PROJECT_DIR/../SearchlandContext/AvailableFiltersInSearchLand_ACTUAL.md" >> "$OUTPUT_DIR/shared_context.txt" 2>/dev/null || echo "[AvailableFiltersInSearchLand_ACTUAL.md not found]" >> "$OUTPUT_DIR/shared_context.txt"

echo "" >> "$OUTPUT_DIR/shared_context.txt"
echo "## REFERENCE: Preset Filters (86 Expert Examples)" >> "$OUTPUT_DIR/shared_context.txt"
echo "" >> "$OUTPUT_DIR/shared_context.txt"
cat "$PROJECT_DIR/../SearchlandContext/PresetFiltersBuiltIntoSearchLand.md" >> "$OUTPUT_DIR/shared_context.txt" 2>/dev/null || echo "[PresetFiltersBuiltIntoSearchLand.md not found]" >> "$OUTPUT_DIR/shared_context.txt"

echo "" >> "$OUTPUT_DIR/shared_context.txt"
echo "## REFERENCE: Preset Strategy Guide" >> "$OUTPUT_DIR/shared_context.txt"
echo "" >> "$OUTPUT_DIR/shared_context.txt"
cat "$PROJECT_DIR/../PRESET_STRATEGY_GUIDE.md" >> "$OUTPUT_DIR/shared_context.txt" 2>/dev/null || echo "[PRESET_STRATEGY_GUIDE.md not found]" >> "$OUTPUT_DIR/shared_context.txt"
