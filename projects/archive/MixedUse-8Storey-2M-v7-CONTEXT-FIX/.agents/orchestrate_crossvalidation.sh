...
echo "" >> "$OUTPUT_DIR/critique_context.txt"
cat "$PROJECT_DIR/../SearchlandContext/AvailableFiltersInSearchLand_ACTUAL.md" >> "$OUTPUT_DIR/critique_context.txt" 2>/dev/null || echo "[AvailableFiltersInSearchLand_ACTUAL.md not found]" >> "$OUTPUT_DIR/critique_context.txt"

echo "" >> "$OUTPUT_DIR/critique_context.txt"
echo "## REFERENCE: LEARNINGS_DATABASE.md" >> "$OUTPUT_DIR/critique_context.txt"
echo "" >> "$OUTPUT_DIR/critique_context.txt"
cat "$PROJECT_DIR/../LEARNINGS_DATABASE.md" >> "$OUTPUT_DIR/critique_context.txt" 2>/dev/null || echo "[LEARNINGS_DATABASE.md not found]" >> "$OUTPUT_DIR/critique_context.txt"
