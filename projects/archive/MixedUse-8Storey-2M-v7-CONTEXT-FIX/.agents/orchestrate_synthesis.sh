...
echo "" >> "$VALIDITY_DIR/synthesis_context.txt"
cat "$PROJECT_DIR/../SearchlandContext/AvailableFiltersInSearchLand_ACTUAL.md" >> "$VALIDITY_DIR/synthesis_context.txt" 2>/dev/null || echo "[AvailableFiltersInSearchLand_ACTUAL.md not found]" >> "$VALIDITY_DIR/synthesis_context.txt"

echo "" >> "$VALIDITY_DIR/synthesis_context.txt"
echo "## REFERENCE: LEARNINGS_DATABASE.md" >> "$VALIDITY_DIR/synthesis_context.txt"
echo "" >> "$VALIDITY_DIR/synthesis_context.txt"
cat "$PROJECT_DIR/../LEARNINGS_DATABASE.md" >> "$VALIDITY_DIR/synthesis_context.txt" 2>/dev/null || echo "[LEARNINGS_DATABASE.md not found]" >> "$VALIDITY_DIR/synthesis_context.txt"

echo "" >> "$VALIDITY_DIR/synthesis_context.txt"
echo "## REFERENCE: FILTER_PATTERNS.md" >> "$VALIDITY_DIR/synthesis_context.txt"
echo "" >> "$VALIDITY_DIR/synthesis_context.txt"
cat "$PROJECT_DIR/../FILTER_PATTERNS.md" >> "$VALIDITY_DIR/synthesis_context.txt" 2>/dev/null || echo "[FILTER_PATTERNS.md not found]" >> "$VALIDITY_DIR/synthesis_context.txt"
