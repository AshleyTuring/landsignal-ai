...
cat > "$VALIDITY_DIR/iteration_context.txt" << CONTEXT_EOF
$CONTEXT_ITERATION
CONTEXT_EOF
...
iterate_claude() {
    if [ "$CLAUDE_LIMIT_HIT" = true ]; then
        ...
        echo "Context file: $VALIDITY_DIR/iteration_claude_prompt.txt"
        echo "Output file: $VALIDITY_DIR/Iteration_Claude.md"
